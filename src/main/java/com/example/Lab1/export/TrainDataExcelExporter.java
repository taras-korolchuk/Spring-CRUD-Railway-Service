...
public class TrainDataExcelExporter {
    private XSSFWorkbook workbook;
    private XSSFSheet sheet;
    private List<TrainEntity> trainEntities;

    public TrainDataExcelExporter(List<TrainEntity> trainEntities) {
    ...
    private void writeDataLines() {
        ...
        for (TrainEntity trainEntity : trainEntities) {
            ...
            createCell(row, columnCount++, trainEntity.getTrainId(), style);
            createCell(row, columnCount++, trainEntity.getTrainNumber(), style);
        }
    }
